...
def menssagem_sucesso():
    suecesso = st.success('Arquivo baixado com sucesso!', icon = "✅")
    time.sleep(5)
    suecesso.empty()
...
with coluna1:
    ...
    nome_arquivo += '.csv'
with coluna2:
    st.download_button('Fazer o download da tabela em csv',data = converte_csv(dados_filtrados), file_name = nome_arquivo,mime = 'text/csv', on_click= menssagem_sucesso)
